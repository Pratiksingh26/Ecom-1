...
export function Cart() {
  ...
  function getData() {
    axios
      .get("https://prateekapi.herokuapp.com/api/cart")
      .then(({ data }) => {
        setArr(data);
      })
  ...
  function handleCount(id, val) {
    ...
    if (qty > 0) {
      arr.splice(id, 1);
      axios
        .patch(`https://prateekapi.herokuapp.com/api/cart/${obj.id}`, { qty: qty + val })
        .then(({ data }) => {
  ...
  function handleDelete(id) {
    ...
    arr.splice(id, 1);
    axios
      .delete(`https://prateekapi.herokuapp.com/api/cart/${obj.id}`)
